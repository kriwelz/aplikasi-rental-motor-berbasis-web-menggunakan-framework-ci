...
<div class="container">
    ...
    <div align="center">
        ...
        <div align="left">
            <table>
                <?php if(isset($data_pemesanan)){ foreach($data_pemesanan as $row) { ?>
                    <tr>
                    ...
                    <tr>
                        <td width="65%"><strong>Tanggal Penjualan : </strong> <?php echo date("d M Y",strtotime($row->tgl_pemesanan));?></td>
        ...
        <?php if(isset($data_pemesanan)){ foreach($data_pemesanan as $row) { ?>
            <h5 style="float:right;">
                Total : <?php echo currency_format($row->harga_pemesanan)?>
            </h5>
        <?php }}?>
    </div>
    <br/>

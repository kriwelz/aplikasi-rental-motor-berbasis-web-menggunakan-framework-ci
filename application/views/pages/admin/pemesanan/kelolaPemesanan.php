                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if(isset($data_pemesanan)){
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row->harga_pemesanan; ?></td>
                                            <td>
                                               <?php
                                                if($row->status_pemesanan == 'Menunggu') { ?>
                                                    ...
                                                    <a href="" class="btn btn-info btn-round" disabled> Dikembalikan</button>
                                                    <a href="" class="btn btn-default btn-round" disabled> Selesai</button>
                                                <?php } else { 

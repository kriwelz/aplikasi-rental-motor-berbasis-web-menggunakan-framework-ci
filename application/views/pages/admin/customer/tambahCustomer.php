                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapse2" class="body collapse in">
                                    <form  method="post" action="<?php echo site_url('Cafe_Controller/prosesTambahPelanggan')?>" class="form-horizontal" id="popup-validation">
                                        ...
                                        <div style="text-align:center" class="form-actions no-margin-bottom">
                                            ...
                                            <a href="<?php echo site_url('Cafe_Controller/tambahPelanggan')?>" class="btn btn-default btn-round">Cancel</a>
                                        </div>
                                    </form>
                                </div>
                            </div>

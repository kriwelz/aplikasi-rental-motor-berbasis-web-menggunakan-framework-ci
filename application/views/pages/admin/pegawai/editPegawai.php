                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapse2" class="body collapse in">
                                    <form  method="post" action="<?php echo site_url('Admin_Controller/prosesEditPegawai')?>" class="form-horizontal" id="popup-validation">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" class="validate[required,minSize[6]] form-control" name="username" id="username" value="<?php echo $row->username;?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class=" col-lg-4">
                                                <input class="validate[required,minSize[6]] form-control" type="password" name="password" id="password" value="<?php echo $row->password;?>" />
                                            </div>
                                        </div>
                                        <div class="form-group">
